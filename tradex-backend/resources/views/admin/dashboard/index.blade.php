    ...
    <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4" aria-label="Platform statistics">
        @php
            $cards = [
                ...
                ['label' => 'Orders', 'value' => $overview['orders']['total'], 'detail' => $overview['orders']['pending_review'] . ' pending', 'icon_bg' => 'bg-rose-50', 'icon_text' => 'text-rose-600', 'icon' => '▤', 'url' => route('admin.orders.index')],
