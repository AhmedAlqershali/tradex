    ...
    <div class="min-h-screen lg:flex">
        <aside class="hidden w-72 shrink-0 flex-col bg-slate-950 text-slate-300 lg:flex">
            ...
            <nav class="flex-1 space-y-1 px-4 py-6" aria-label="Admin navigation">
                ...
                <a href="{{ route('admin.merchants.index') }}" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium transition {{ request()->routeIs('admin.merchants.*') || request()->routeIs('admin.stores.*') ? 'bg-indigo-500/15 text-indigo-300' : 'text-slate-300 hover:bg-white/5 hover:text-white' }}">
