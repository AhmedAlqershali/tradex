...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'api.v1.client.cart.clear',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'api.v1.merchant.plans.index',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::Ax1e2DU8prQBavQw',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::siYRvEuYcwAtNioU',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::kwFVOZJrYJ1Y66PG',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/a(?|pi/v1/(?|a(?|uth/email/verify/([^/]++)/([^/]++)(*:59)|dmin/(?|p(?|roducts/([^/]++)(?|(*:97)|/reviews(*:112))|lans/([^/]++)(?|(*:137)))|categories/([^/]++)(?|(*:169))|users/([^/]++)(?|(*:195)|/(?|status(*:213)|role(*:225))|(*:234))|s(?|tores/([^/]++)(?|(*:264)|/status(*:279))|ubscription\\-requests/([^/]++)(?|(*:321)|/(?|approve(*:340)|reject(*:354)|proof(*:367))))|reviews/([^/]++)(*:394)))|stores/([^/]++)(*:419)|products/([^/]++)(?|(*:447)|/reviews(?|(*:466)))|notifications/([^/]++)/read(*:503)|cart/items/([^/]++)(?|(*:533))|orders/([^/]++)(?|(*:560))|favorites/([^/]++)(?|(*:590))|reviews/([^/]++)(*:615)|merchant/(?|products/([^/]++)(?|(*:655))|orders/([^/]++)(?|(*:682)|/status(*:697))|s(?|tores/([^/]++)(?|(*:727)|/logo(*:740))|ubscription\\-requests/([^/]++)(*:779))))|dmin/(?|merchants/([^/]++)(?|(*:819)|/subscription\\-requests/([^/]++)/(?|approve(*:870)|reject(*:884)))|stores/([^/]++)(?|(*:912)|/status(*:927))|orders/([^/]++)(?|(*:954)|/status(*:969))|products/([^/]++)(*:995)|categories/([^/]++)(?|/edit(*:1030)|(*:1039))))|/storage/(.*)(?|(*:1067)))/?$}sDu',
    ),
    3 => 
    array (
      59 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.merchants.subscription-requests.approve',
          ),
          1 => 
          array (
            0 => 'merchant',
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.merchants.subscription-requests.reject',
          ),
          1 => 
          array (
            0 => 'merchant',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\AuthController@google',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\AuthController@google',
        'as' => 'api.v1.auth.google',
        'namespace' => NULL,
        'prefix' => 'api/v1/auth',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\Client\\CartController@clear',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\Client\\CartController@clear',
        'as' => 'api.v1.client.cart.clear',
        'namespace' => NULL,
        'prefix' => 'api/v1',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\V1\\Merchant\\SubscriptionController@indexPlans',
        'controller' => 'App\\Http\\Controllers\\Api\\V1\\Merchant\\SubscriptionController@indexPlans',
        'as' => 'api.v1.merchant.plans.index',
        'namespace' => NULL,
        'prefix' => 'api/v1/merchant',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:46:"fn () => \\redirect()->route(\'admin.dashboard\')";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"000000000000087d0000000000000000";}}',
        'as' => 'admin.home',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
    ...
    array (
      ...
      array (
        ...
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:128:"fn () => \\redirect()->to(
    ...
    'admin.merchants.subscription-requests.approve' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'admin/merchants/{merchant}/subscription-requests/{subscriptionRequest}/approve',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\MerchantController@approveSubscription',
        'controller' => 'App\\Http\\Controllers\\Admin\\MerchantController@approveSubscription',
        'as' => 'admin.merchants.subscription-requests.approve',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    'admin.merchants.subscription-requests.reject' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'admin/merchants/{merchant}/subscription-requests/{subscriptionRequest}/reject',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\MerchantController@rejectSubscription',
        'controller' => 'App\\Http\\Controllers\\Admin\\MerchantController@rejectSubscription',
        'as' => 'admin.merchants.subscription-requests.reject',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Admin\\StoreController@updateStatus',
        'controller' => 'App\\Http\\Controllers\\Admin\\StoreController@updateStatus',
        'as' => 'admin.stores.status',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:3:{s:4:"disk";s:5:"local";s:6:"config";a:5:{s:6:"driver";s:5:"local";s:4:"root";s:33:"/var/www/html/storage/app/private";s:5:"serve";b:1;s:5:"throw";b:0;s:6:"report";b:0;}s:12:"isProduction";b:0;}s:8:"function";s:323:"function (\\Illuminate\\Http\\Request $request, string $path) use ($disk, $config, $isProduction) {
                ...
                }";s:5:"scope";s:47:"Illuminate\\Filesystem\\FilesystemServiceProvider";s:4:"this";N;s:4:"self";s:32:"00000000000005360000000000000000";}}',
        'as' => 'storage.local',
      ),
      'fallback' => false,
      'defaults' => 
