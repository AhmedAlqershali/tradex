...
class AppLocalizations {
  ...
  String _value(String key) =>
    ...
    'ar': {
      ...
      'aboutHeroDescription': 'تجربة AI مجانية لمدة 14 يومًا، وبعدها يحتاج التاجر إلى الخطة المدفوعة للاستمرار في استخدام ميزات الذكاء الاصطناعي. توجد عمولة 5% فقط على الطلبات المكتملة.',
      ...
      'aboutAiToolsDescription': 'استخدم أدوات الذكاء الاصطناعي مجانًا لمدة 14 يومًا، وبعد انتهاء التجربة يحتاج التاجر إلى الخطة المدفوعة للاستمرار. تُحتسب عمولة 5% فقط عندما يصبح الطلب completed.',
      ...
      'aboutPurposeDescription': 'تجمع Tradex بين المتسوقين والتجار في مكان واحد، مع تجربة AI مجانية لمدة 14 يومًا ثم اشتراك مدفوع للمتابعة، وعمولة 5% فقط على الطلبات المكتملة.',
      'language': 'اللغة',
    ...
    'en': {
      ...
      'aboutHeroDescription': 'AI is free for 14 days. After that, merchants need the paid AI plan to keep using AI features. A 5% commission applies only to completed orders.',
      ...
      'aboutAiToolsDescription': 'Use AI tools free for 14 days. After the trial ends, merchants need the paid AI plan to continue. A 5% commission is charged only when an order is completed.',
      ...
      'aboutPurposeDescription': 'Tradex brings shoppers and merchants together in one place, with a free 14-day AI trial, then the paid AI plan, and a 5% commission only on completed orders.',
      'language': 'Language',
